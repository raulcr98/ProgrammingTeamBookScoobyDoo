# Taken from min_25 submission's on some problem in hackerrank. It uses 64-bit fft and is extremely fast almost comparable to C++ codes. For usage just call poly_mul with the polynomials.
from random import *
import time
